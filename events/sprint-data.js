...
<div class="snapcard"><div class="scale">project · community data</div><h4>The MFNERC data story</h4><p>A culturally grounded data project with the Manitoba First Nations Education Resource Centre. The model for small, local, identity-relevant student inquiry.</p><a class="go" href="https://c21canada.org/wp-content/uploads/2025/07/MB-MFNERC-PDF-AIUseCase-2025.pdf" rel="noopener" target="_blank">the AI use case (PDF) →</a></div>
...
<div class="block">
<div class="callout capture"><div class="callout-head"><svg class="ico" viewBox="0 0 24 24"><rect x="9" y="3" width="6" height="4" rx="1"/><path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"/><path d="M9 14l2 2 4-4"/></svg><span class="verb">Capture &rarr; Blueprint</span><span class="callout-sub">Section 6 · your first move</span></div><div class="callout-body"><p class="cap-lead">Name your first move, then upload.</p><ul class="steps"><li><b>Your first move back home.</b> Not a 30-day plan, the very next thing: book the room, pitch my principal, email the three teachers I need.</li><li><b>Upload your Blueprint to the pilot pool.</b> The Dell Education Team reviews everything submitted, and selected programs get support to launch a real pilot.</li></ul><button class="bp-jump" data-bpfield="firstmove">Write your first move &rarr;</button><div class="links" style="margin-top:12px"><a href="https://drive.google.com/drive/folders/1IEsV4pJ2TByfDua3PwfwVqcl3diGOIxL?usp=sharing" target="_blank" rel="noopener">Upload your Blueprint to the pilot-pool folder<span class="note">opens the shared folder</span></a></div></div></div>
</div>`
  },
];
